    ...
    return (
      <div className="bg-fixed bg-[url('/Drugs.jpg')] bg-no-repeat bg-cover ">
        ...
        <div className="pt-20 flex flex-col justify-center ">  {/*bg-gray-500 opacity-25*/}
            <div className="text-white font-bold text-7xl text-center"><FlipWords words={words} className="text-white z-0"/>Abuse</div>
            <div className=" pt-2 text-white text-center">
                ...
                There are various substances and drugs that acan be abused.</div>
                <br/><br/><br/>
            <div className="text-white font-bold text-3xl text-center">Alcohol</div>
            ...
            <br/><br/><br/>
            <div className="text-white font-bold text-3xl text-center"> Prescription and Over-the-Counter (OTC) Medicine </div>
